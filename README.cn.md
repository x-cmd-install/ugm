...
| last180d | 2026-03-15 | 1 | 0 | 0 | 0 | 0 | 2 |
| 360d | 2025-09-16 | 1 | 0 | 0 | 0 | 0 | 2 |
| last720d | 2024-09-21 | 3 | 0 | 0 | 0 | 1 | 4 |
...
在 [repology.org](https://repology.org/project/ugm) 上共有 **14** 个发行版报告此项目。**6** 个 ✅ 已是最新上游版本，**8** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Nix unstable | `1.9.0` | ✅ latest |
| Alpine edge | `1.9.0` | ✅ latest |
...
_数据快照: `data/card/260911.yml` · 2026-09-11T04:51:43Z._
