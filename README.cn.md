...
[![x-cmd/install — ugm Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ugm.svg?lang=zh)](https://x-cmd.com/install/ugm)
...
- **上游仓库**: <https://github.com/ariasmn/ugm>
- **许可证**: MIT
...
- **Star**: 162 · **Fork**: 4 · **开放 issue**: 3 · **贡献者**: 1

## 累计统计

- **发布数**: 10 · **已合并 PR**: 0 · **开放 PR**: 0 · **已关闭 issue**: 2 · **开放 issue**: 1 · **提交数**: 41
...
| last180d | 2026-03-28 | 1 | 0 | 0 | 0 | 0 | 2 |
| 360d | 2025-09-29 | 1 | 0 | 0 | 0 | 0 | 2 |
| last720d | 2024-10-04 | 3 | 0 | 0 | 0 | 1 | 4 |
...
ugm 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `ugm` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ugm.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:56:19Z._
